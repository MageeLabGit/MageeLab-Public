...
do				
		...
		if(c<=1850)
			if ((C<=1683 && C>=1600) || (C<=1749 && C>=1725)) //increase p01 ~3x for these chains
				ll=(runmod0[j]*3)-2
				if (j==1)
					print c, "up", ll
				endif
...
p=00	
	do
		...
		findlevels /r=[100,5100]/q /edge=1 /d=desty $jst, 11.7
		wavestats /q $jst
		
//		print p, V_levelsfound, V_max
...
//			print jst, runs1(desty[0]), desty[0], V_max
